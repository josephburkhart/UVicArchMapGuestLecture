...
# Notes for new users:
# -  The input layer must have the following fields called "GridID" (text) and id (int)
...
# Inputs
path_to_input_layer = "C:\\Users\\Joseph\\Work\\PostUBC\\UVic_MappingGuestLecture\\GIS-Private\\"
input_layer = QgsVectorLayer(path_to_input_layer + "Grid20m-2.geojson", "mygeojson", "ogr")
input_features = input_layer.getFeatures()

sides = 4

# Outputs
output_layer = QgsVectorLayer("Polygon?crs=epsg:3857", "OutputLayer", "memory")   #make a scratch layer so there is no risk of overwriting a file accidentally
